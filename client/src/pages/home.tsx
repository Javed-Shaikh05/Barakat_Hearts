...
// GameificationSection import removed as stats tab was removed
...
export default function Home() {
  ...
  useEffect(() => {
    document.title = "Beautiful Duas and Blessings";
  ...
  const renderTabContent = () => {
    switch (activeTab) {
      ...
      // Stats case removed as requested
      case "duas":
        return (
          <div className="max-w-4xl mx-auto px-4 py-8">
            <div className="text-center">
              <h2 className="text-3xl font-serif font-bold text-maroon mb-6">
                🤲 Beautiful Duas 🤲
              </h2>
              <div className="grid gap-6 md:gap-8">
                ...
                <div className="glass-effect rounded-2xl p-6 text-center">
                  ...
                  <p className="text-maroon text-sm mt-2">- Hadith</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="text-center">
              ...
              <div className="grid gap-6 md:gap-8">
                <div className="glass-effect rounded-2xl p-6 text-center">
                  ...
                  <p className="text-maroon text-sm mt-2">- Quran 30:21</p>
                </div>
                <div className="glass-effect rounded-2xl p-6 text-center">
                  <div className="text-2xl mb-4">🌹</div>
                  <h3 className="text-xl font-semibold text-maroon mb-3">
                  ...
                  <p className="text-maroon text-sm mt-2">
                ...
                <div className="glass-effect rounded-2xl p-6 text-center">
                  ...
                  <p className="text-maroon text-sm mt-2">- Quran 25:74</p>
                </div>
                <div className="glass-effect rounded-2xl p-6 text-center">
